...
label_id = canvas.create_text(25,60, text="126373827785")
label_name = canvas.create_text(30,100, text="Saatesh.Janki")
label_dob = canvas.create_text(53,120, text="sept, 4, 2009")
label_pin = canvas.create_text(32,140, text="1946")
label_address = canvas.create_text(25,60, text="Toronto,ON")
label_vehicle_type = canvas.create_text(155,180, text="car")

# Define the function

def myLisence():
    ide = "1839374937u549784"
    name = "Saatehs"
    dob = "djksd"
    pin = "2938"
    address = "totonto,WI"
...
# Create a button
button1 = Button(root, text="update", command=myLisence)
